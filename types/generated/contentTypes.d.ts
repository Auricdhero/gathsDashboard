...
export interface ApiAboutPageAboutPage extends Schema.SingleType {
  ...
  attributes: {
    AboutCover: Attribute.String;
    missionTitle: Attribute.String;
    missionDetail: Attribute.Text;
    missionQuote: Attribute.Text;
    missionPic: Attribute.Media;
...
export interface ApiExecutiveExecutive extends Schema.CollectionType {
  ...
  attributes: {
    ExecutivePic: Attribute.Media;
    Name: Attribute.String;
    Position: Attribute.String;
    slug: Attribute.UID<'api::executive.executive', 'Name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiTestimonyTestimony extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::testimony.testimony', 'Name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
